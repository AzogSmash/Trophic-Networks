...
void simulationDynamique(Sommet *sommets, int nbSommets, Arc *arcs, int nbArcs, int iterations) {
    ...
    if (choixSimulation == 1) {
        ...
        if (nbSommets==10){
            ...
            // Initialisation
            float tempPop[] = {10, 50, 200, 1000, 300, 800, 5000, 50, 1000, 3000};
            ...
            float tempCroissance[] = {0.4, 0.1, 0.04, 0.05, 0.08, 0.3, 0.5, 0.05, 0.05,0.06,0.2,0.03,0.03,0.02};
            float tempCharge[] = {4000, 800, 500, 500, 60, 1200, 10000, 20000, 250, 400,6000,100,90,50};
            ...
            float tempCroissance[] = {0.05, 0.1, 0.05, 0.1, 0.1, 0.15, 0.2, 0.05, 0.05,0.05,0.1,0.05,0.1,0.05,0.02,0.02,0.4,0.1,0.05,0.2,0.3};
            float tempCharge[] = {50, 200, 300, 150, 500, 80, 1000, 500, 1000, 500,150,80,30,50,50,100,10000,500,500,150,2000};
